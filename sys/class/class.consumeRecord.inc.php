 ...
 */
class ConsumeRecord extends DB_Connect {
	...
	{
		// 若action设置不正确，退出
		if($_POST['action'] != 'consume_record_new')
		{
			return "不合法请求";
		}
		...
		// 不添加记录编号，会自动按顺序生成
		$query = "INSERT INTO `consume_record`
		(consumeRecord_item_id, consumeRecord_quantity, consumeRecord_state, consumeRecord_stime, consumeRecord_etime, consumeRecord_confirmed)
